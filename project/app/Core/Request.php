...
class Request
{
    ...
    public function __construct($method)
    {
        ...
        $this->login_user_id = $_SESSION["_loginUserId"]??null;
        ...
        {
            $user = $this->setLoginUser($this->login_user_id);
        }
    }
    ...
    {
        $_SESSION["_loginUserId"] = $id;
        $user = Database::getUser($this->login_user_id);

        if($user) {
            $this->login_user_id = trim($id);
    ...
    {
        return (!empty($this->login_user) )?true:false;
    }
}